...
--
-- Host: 127.0.0.1
-- Generation Time: May 05, 2023 at 11:41 AM
...
(1, 'Thinh Tu', 'user1@gmail.com', '$2y$10$WOKW1JD0m5oX8gRaq6uzUO.KozKHpty3FKUa0TwkcHhopM7dnMxJG', '3, 2, 4', 1, ''),
(2, 'Phúc You', 'user2@gmail.com', '$2y$10$4nzFhtF/vntRfAQK3LoPEe4jxvcWWNyy6m3ZyLffXdAV6BYw9h/zi', '', 1, ''),
(3, 'Dương :vvv', 'user3@gmail.com', '$2y$10$4nzFhtF/vntRfAQK3LoPEe4jxvcWWNyy6m3ZyLffXdAV6BYw9h/zi', '', 1, ''),
(18, 'Thinh Khong Suy', 'dhdncndhxn650@gmail.com', '$2y$10$9a29aV3eitqSkavv5qXBXeJQgrrQA5ViTz07J2xeABcYQpHMn2Vom', '', 1, '');
...
--
ALTER TABLE `binh_luan`
  MODIFY `id_binh_luan` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=103;
...
--
ALTER TABLE `reset_token`
  MODIFY `id_reset_token` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=16;
