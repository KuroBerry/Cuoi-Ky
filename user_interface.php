...
if (isset($_SESSION['ID']) && isset($_SESSION['name'])) {
    ...
    if ($avatar != '') {
        $avatar_path = $path . DIRECTORY_SEPARATOR . 'users'
            . DIRECTORY_SEPARATOR . $_SESSION['ID'] . DIRECTORY_SEPARATOR . $avatar;
    } else {
        $avatar_path = 'https://encrypted-tbn0.gstatic.com/images?"
            . "q=tbn:ANd9GcTPuksIeXJ7lssfJxg3shTub7fzB06fkvhr0rFsn_s&s';
    }
